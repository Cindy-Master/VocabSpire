...
public static class ChangelogPopup
{
    ...
    {
        "· 新增「回忆卡片」题型：看词自己回忆 → 翻面自评「想起来了/没想起来」",
        "· 选择题/拼写题新增「🤔 忘了」按钮：想不起来直接看答案，不用瞎蒙",
        "· 新增「高考大纲词汇3500（乱序版）」词库（2012 词）",
        // 不在这里举怪字原样（U+2ED3 等字符游戏字体未必有字形，会显示成方块反被当成 bug）
        "· 修复雅思/专升本/托业词库释义里的异体怪字（长、车、门、食等，共 1278 处）",
    };
